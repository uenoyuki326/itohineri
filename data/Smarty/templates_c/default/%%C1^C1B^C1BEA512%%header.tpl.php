<?php /* Smarty version 2.6.26, created on 2013-05-15 16:20:43
         compiled from C:%5Cxampp%5Chtdocs%5Ceccube//data/Smarty/templates/default/header.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'C:\\xampp\\htdocs\\eccube//data/Smarty/templates/default/header.tpl', 29, false),array('modifier', 'h', 'C:\\xampp\\htdocs\\eccube//data/Smarty/templates/default/header.tpl', 29, false),array('modifier', 'count', 'C:\\xampp\\htdocs\\eccube//data/Smarty/templates/default/header.tpl', 35, false),)), $this); ?>

<!--▼HEADER-->
<div id="header_wrap">
    <div id="header" class="clearfix">
        <div id="logo_area">
            <p id="site_description">このSHOPはテストです</p>
            <h1>
...
img/common/logo.gif" alt="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrSiteInfo']['shop_name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
...
" /><span>/<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['tpl_title'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
</span></a>
            </h1>
        </div>
